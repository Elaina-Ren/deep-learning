...
class Net(nn.Module):
    ...
    def forward(self, x):
        ...
        if(self.use_gcblock):
            ...
            gcparamsLinear12=self.fc1(gcparamsLinear12)
            gcparamsLinear12=self.relu(gcparamsLinear12)
            gcparamsLinear12=self.dropout(gcparamsLinear12)
        ...
        if(self.use_gcblock):
            ...
            gcparamsLinear23=self.fc2(gcparamsLinear23)
            gcparamsLinear23=self.relu(gcparamsLinear23)
            gcparamsLinear23=self.dropout(gcparamsLinear23)
        ...
        if(self.use_gcblock):
            ...
            gcparamsLinear34=self.fc3(gcparamsLinear34)
            gcparamsLinear34=self.relu(gcparamsLinear34)
            gcparamsLinear34=self.dropout(gcparamsLinear34)
