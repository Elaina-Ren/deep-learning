...
class ResNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.gcblock1=GCLayer(64,8)
        self.gcblock2=GCLayer(128,12)
        self.gcblock3=GCLayer(256,14)
        self.gcblock4=GCLayer(512,16)
...
def resnet18(num_classes=1000, include_top=True, use_gcblock=False):
    # https://download.pytorch.org/models/resnet34-333f7ec4.pth
    return ResNet(BasicBlock, [2, 2, 2, 2], num_classes=num_classes, include_top=include_top, use_gcblock=use_gcblock)


def resnet34(num_classes=1000, include_top=True, use_gcblock=False):
    # https://download.pytorch.org/models/resnet34-333f7ec4.pth
    return ResNet(BasicBlock, [3, 4, 6, 3], num_classes=num_classes, include_top=include_top, use_gcblock=use_gcblock)


def resnet50(num_classes=1000, include_top=True, use_gcblock=False):
    # https://download.pytorch.org/models/resnet50-19c8e357.pth
    return ResNet(Bottleneck, [3, 4, 6, 3], num_classes=num_classes, include_top=include_top, use_gcblock=use_gcblock)
