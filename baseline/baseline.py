...
#这是已经划分好训练和测试数据集了的
trainset = torchvision.datasets.CIFAR100(root='/content/drive/MyDrive/DataSet', train=True,
                                        download=True, transform=transform)
trainloader = torch.utils.data.DataLoader(trainset, batch_size=batch_size,
                                          shuffle=True, num_workers=2)

testset = torchvision.datasets.CIFAR100(root='/content/drive/MyDrive/DataSet', train=False,
                                       download=True, transform=transform)
...
with open("/content/drive/MyDrive/DeepLearnning/FinalPro/res18bottle-accu.txt", "w") as f:
