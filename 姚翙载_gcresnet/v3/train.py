...
def main():
    ...
    model = resnet18(num_classes=parameters.CIFAR100_class,use_gcblock=True)
    print(model.use_gcblock)
    model.to(device)
    ...
    for epoch in range(epochs):
        ...
        function.writer_into_excel_onlyval(save_path, train_loss_list, train_acc_list, val_acc_list, "CIFAR100_baseline")
